...
class ExerciseDBHandler2(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    companion object {
        @Volatile
        private var INSTANCE: ExerciseDBHandler2? = null

        fun getInstance(context: Context): ExerciseDBHandler2 {
            return INSTANCE ?: synchronized(this) {
                INSTANCE ?: ExerciseDBHandler2(context.applicationContext).also { INSTANCE = it }
            }
        }
    }
}
